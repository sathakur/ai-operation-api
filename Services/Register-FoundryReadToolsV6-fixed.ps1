...
# IMPORTANT:
# Build URIs by concatenation so PowerShell does not misinterpret
# the '?' next to a variable during string interpolation.
$sourceUri =
    $ProjectEndpoint +
    "/agents/" +
    $AgentName +
...
$Tools = @(
    (New-EmptyTool `
        ...
        -Description "Retrieve real Azure subscription inventory."),

    (New-EmptyTool `
        -Name "get_vms" `
        -Description "Retrieve real Azure virtual machine inventory."),

    (New-EmptyTool `
        -Name "get_vm_count" `
        -Description "Retrieve the real total Azure VM count."),

    (New-EmptyTool `
        -Name "get_resource_groups" `
        -Description "Retrieve real Azure resource group inventory."),

    (New-EmptyTool `
        -Name "get_resource_summary" `
        -Description "Retrieve real Azure resource counts grouped by resource type. Must be used for resource summary requests."),

    (New-EmptyTool `
        -Name "get_subnets" `
        -Description "Retrieve real Azure subnet inventory."),

    (New-EmptyTool `
        -Name "get_resources" `
        -Description "Retrieve general Azure resource inventory."),

    (New-EmptyTool `
        -Name "get_storage_accounts" `
        -Description "Retrieve real Azure Storage Account inventory. Must be used for storage account requests."),

    (New-EmptyTool `
        -Name "get_resource_count" `
        -Description "Retrieve the real total Azure resource count.")
)
...
Write-Host "Create URI: $newVersionUri"
